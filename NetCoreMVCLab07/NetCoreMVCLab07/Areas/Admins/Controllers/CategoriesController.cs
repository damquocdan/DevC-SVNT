...
namespace NetCoreMVCLab07.Areas.Admins.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,Name,Status,CreateDate,Image,Description")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,Name,Status,CreateDate,Image,Description")] Category category)
        {
