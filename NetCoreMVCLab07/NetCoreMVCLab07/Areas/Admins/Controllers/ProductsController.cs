...
namespace NetCoreMVCLab07.Areas.Admins.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,ProductPrice,ProductSale,Status,CategoryId,Image,Description")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,ProductName,ProductPrice,ProductSale,Status,CategoryId,Image,Description")] Product product)
        {
